...
public class Practice03SweepGradientView extends View {
    ...
    public Practice03SweepGradientView(Context context, @Nullable AttributeSet attrs, int
            defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        Shader sweepGradient = new SweepGradient(300, 300, Color.parseColor("#E91E63"), Color
                .parseColor("#2196F3"));
