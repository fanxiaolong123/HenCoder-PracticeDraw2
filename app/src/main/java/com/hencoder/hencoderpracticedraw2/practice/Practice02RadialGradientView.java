...
public class Practice02RadialGradientView extends View {
    ...
    public Practice02RadialGradientView(Context context, @Nullable AttributeSet attrs, int
            defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        Shader radialGradient = new RadialGradient(300, 300, 200, Color.parseColor("#E91E63"),
