...
public class Practice01LinearGradientView extends View {
    ...
    public Practice01LinearGradientView(Context context, @Nullable AttributeSet attrs, int
            defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        Shader linearGradient = new LinearGradient(100, 100, 500, 500, Color.parseColor("#E91E63"), Color
